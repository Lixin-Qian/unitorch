...
class MBartForGeneration(_MBartForGeneration):
    ...
    def from_core_configure(cls, config, **kwargs):
        ...
        config_path = (
            pretrained_mbart_infos[config_name_or_path]["config"]
            if config_name_or_path in pretrained_mbart_infos
        ...
        if pretrained_name is not None:
            ...
            weight_path = (
                ...
                and "weight" in pretrained_mbart_infos[pretrained_name_or_path]
