...
class XProphetNetForGeneration(_XProphetNetForGeneration):
    def __init__(
        self,
        config_path: str,
        freeze_word_embedding: bool = True,
    ...
    def from_core_configure(cls, config, **kwargs):
        ...
        config_path = (
            pretrained_xprophetnet_infos[config_name_or_path]["config"]
            if config_name_or_path in pretrained_xprophetnet_infos
        ...
        if pretrained_name is not None:
            ...
            weight_path = (
                pretrained_xprophetnet_infos[pretrained_name_or_path]["weight"]
                if pretrained_name_or_path in pretrained_xprophetnet_infos
                and "weight" in pretrained_xprophetnet_infos[pretrained_name_or_path]
