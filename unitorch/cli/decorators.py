...
import inspect
from unitorch.cli import get_default_setting
...
def add_default_section_for_init(section, default_params=dict()):
    """
    section: default section for class initialization
    default_params: dict(key1=value1)
    """
...
def add_default_section_for_function(
    ...
    """
    section: default section for functions
    default_params: dict(key1=value1)
    """
