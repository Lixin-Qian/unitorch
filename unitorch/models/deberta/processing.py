...
class DebertaProcessor(HuggingfaceClassificationProcessor):
    def __init__(
        ...
        """
        Args:
            vocab_path: vocab file path in deberta tokenizer
            merge_path: merge file path in deberta tokenizer
